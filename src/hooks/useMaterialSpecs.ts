...
export const useMaterialSpecs = (
  ...
  const [materialSpecs, setMaterialSpecs] = useState<{[materialId: string]: MaterialSpec}>(() => {
  ...
  const handleEdgeMaterialChange = useCallback((materialId: string, edgeMaterial: EdgeMaterial | null) => {
  ...
  const handleGlueTypeChange = useCallback((materialId: string, glueType: string) => {
    setMaterialSpecs(prev => ({
      ...prev,
      [materialId]: {
        ...prev[materialId],
  ...
  const handlePieceChange = useCallback((materialId: string, pieceId: string, updatedPiece: Partial<CuttingPiece>) => {
    setMaterialSpecs(prev => ({
      ...prev,
      [materialId]: {
        ...prev[materialId],
  ...
  const handleRemovePiece = useCallback((materialId: string, pieceId: string) => {
    setMaterialSpecs(prev => ({
      ...prev,
      [materialId]: {
        ...prev[materialId],
