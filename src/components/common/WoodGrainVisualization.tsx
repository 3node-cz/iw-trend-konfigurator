      ...
      >
        ...
        <Box
          sx={{
            ...
            width: '100%',
            height: '100%',
            background: `url(${woodGrainImage}) center/cover no-repeat, linear-gradient(${grainDirection === 'vertical' ? '0deg' : '90deg'}, 
              #D2B48C 0%, 
              #DEB887 10%, 
              #D2B48C 20%, 
              #DEB887 30%, 
              ...
              #DEB887 90%, 
              #D2B48C 100%)`,
            transform: grainDirection === 'horizontal' ? 'rotate(90deg) scale(1.7)' : 'none',
