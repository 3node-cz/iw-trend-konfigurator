...
export class ConfigurationService {
  ...
  async saveConfiguration(
    ...
    try {
      ...
      const updatedConfigs = addConfigurationToSaved(currentConfigs, newConfiguration)
   ...
   */
  private async getCurrentConfigurations(customerId: string): Promise<CustomerSavedConfigurations> {
    try {
